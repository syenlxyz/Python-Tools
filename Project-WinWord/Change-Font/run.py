...
def run():
    ...
    for file_path in results:
        ...
        doc.Sections(1).Headers(1).Range.Font.Name = FONT_NAME
        doc.Sections(1).Headers(1).Range.Font.Size = FONT_SIZE
        doc.Sections(1).Headers(1).Range.Font.Color = FONT_COLOR
        
        doc.Sections(1).Footers(1).Range.Select()
        doc.Sections(1).Footers(1).Range.Font.Name = FONT_NAME
        doc.Sections(1).Footers(1).Range.Font.Size = FONT_SIZE
